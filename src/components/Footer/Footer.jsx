import { Mail, Send, Facebook, Instagram, Twitter, Linkedin, Phone } from "lucide-react"
...
export function Footer() {
  return (
    <footer className="relative overflow-hidden">
      {/* Main Footer */}
      <div className="bg-gradient-to-br from-orange-400 via-orange-500 to-yellow-500 relative">
        {/* Background Pattern */}
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-24 py-12 md:py-16 max-w-7xl relative z-10">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Get Yourself Discovered!</h2>
            <p className="text-lg text-gray-800 max-w-2xl mx-auto">
              Join the largest Punjabi business community and connect with thousands of customers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            {/* Pages Column */}
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-6">Pages</h3>
            ...
            {/* Business Column */}
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-6">Business</h3>
              <ul className="space-y-3">
                <li>
                  <a href="#" className="text-gray-800 hover:text-gray-900 transition-colors font-medium">
                    Add Your Business
            ...
            <div>
              ...
              <ul className="space-y-3 mb-6">
                <li>
                  <a
                    href="#"
                    className="text-gray-800 hover:text-gray-900 transition-colors font-medium flex items-center gap-2"
                  >
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-col gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 rounded-lg border-0 bg-white/90 backdrop-blur-sm text-gray-900 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-600"
                />
              ...
              {/* App Download Links */}
              <div className="mt-6">
                <p className="text-sm text-gray-800 mb-3 font-medium">Download Our App</p>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              <img src={logo} alt="Punjabi Pages" className="w-8 h-8 rounded-full" />
